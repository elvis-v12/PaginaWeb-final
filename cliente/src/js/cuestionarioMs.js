...
const questions = [
    {
        ...
        options: [
            "A) Un juego de computadora",
            "B) Un tipo de programa de dibujo",
            "C) Un sistema para almacenar y organizar información en tablas",
    ...
    {
        question: "¿Qué tipo de datos se guarda en una base de datos MySQL?",
        options: [
            "A) Solo texto",
            "B) Solo imágenes",
            "C) Solo números",
            "D) Información organizada en tablas",
            "E) Solo videos"
        ],
        correctAnswer: 3 // Índice de la respuesta correcta (D)
    },
    {
        question: "¿Qué comando se usa para obtener todos los datos de una tabla en MySQL?",
        options: [
            "A) GET *",
            "B) SHOW *",
            "C) SELECT *",
    ...
    {
        question: "¿Cómo se llama una columna en una tabla de MySQL?",
        options: [
            "A) Registro",
            "B) Fila",
            "C) Celda",
...
function generarCertificado() {
    ...
    imagen.src = "/public/img/ninos/diplomaMs.jpg"; // Cambia esto por la ruta real de tu imagen
