const questions = [
    ...
    {
        text: "¿Cuál de estos comandos se usa para seleccionar todos los datos de una tabla en MySQL?",
        options: [
    ...
    {
        text: "¿Cuál es la sintaxis correcta para crear una base de datos en MySQL?",
        options: [
    ...
    {
        text: "¿Qué comando se usa para agregar una nueva columna a una tabla en MySQL?",
        options: [
            ...
            "ALTER COLUMN nombre_columna tipo;"
        ],
        correct: "ADD COLUMN nombre_columna tipo;"
    },
    {
    ...
    {
        text: "¿Qué comando se usa para eliminar una tabla completa en MySQL?",
        options: [
    ...
    {
        text: "¿Qué tipo de dato se utiliza para almacenar cadenas de texto en MySQL?",
        options: [
            "VARCHAR",
            "TEXT",
            "STRING",
    ...
    {
        text: "¿Cómo se realiza una consulta con condiciones en MySQL?",
        options: [
    ...
    {
        text: "¿Cómo se ordenan los resultados de una consulta de manera ascendente en MySQL?",
        options: [
    ...
    {
        text: "¿Qué comando se utiliza para insertar datos en una tabla en MySQL?",
        options: [
    ...
    {
        text: "¿Qué tipo de datos se usa para almacenar fechas y horas en MySQL?",
        options: [
            "DATE",
            "TIME",
            "DATETIME",
    ...
    {
        text: "¿Cómo se modifica un valor de una columna en MySQL?",
        options: [
    ...
    {
        text: "¿Qué significa una clave primaria (PRIMARY KEY) en MySQL?",
        options: [
    ...
    {
        text: "¿Cómo se vinculan dos tablas en MySQL?",
        options: [
            "Usando JOIN",
            "Usando LINK",
            "Usando CONNECT",
    ...
    {
        text: "¿Qué comando se utiliza para crear un índice en una tabla en MySQL?",
        options: [
    ...
    {
        text: "¿Cómo se agrega una restricción para que una columna no acepte valores nulos?",
        options: [
            "NOT NULL",
            "NULL",
            "UNIQUE",
    ...
    {
        text: "¿Qué hace el comando `SELECT COUNT(*)` en MySQL?",
        options: [
