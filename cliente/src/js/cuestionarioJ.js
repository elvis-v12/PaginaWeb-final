...
const questions = [
    {
        ...
        options: [
            ...
            "C) let miFuncion = {}",
            "D) func miFuncion {}",
            "E) new function miFuncion() {}"
        ],
        correctAnswer: 0 // Índice de la respuesta correcta (A)
    },
    {
        question: "¿Cuál es el operador para multiplicar en JavaScript? ",
        options: [
            "A) / ",
            "B) %",
            "C) *",
    ...
    {
        question: "¿Cuál es el tipo de dato que almacena texto en JavaScript?",
        options: [
            "A) boolean",
            "B) array",
            "C) number",
    ...
    {
        question: "¿Cuál es el resultado de 10 % 3 en JavaScript?",
        options: [
            "A) 3",
            "B) 0",
            "C) 1",
...
function generarCertificado() {
    ...
    imagen.src = "/public/img/ninos/diploma.jpg"; // Cambia esto por la ruta real de tu imagen

    imagen.onload = function() {
        // Establecer el tamaño del canvas
        var escala = 0.5; // Ajusta este valor para reducir o aumentar el tamaño
        ...
        contexto.font = "20px Franklin"; // Ajusta el tamaño según el nuevo tamaño de la imagen
