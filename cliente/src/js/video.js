import { CursosService } from '/src/js/service/CursosService.js';
import { CursoComentarios } from '/src/js/session-comentarios.js';
import { CursoContent } from '/src/js/session-content.js';
