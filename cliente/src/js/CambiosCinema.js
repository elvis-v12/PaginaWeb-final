document.addEventListener("DOMContentLoaded", async () => {
    ...
    const curso = urlParams.get("curso"); // Ejemplo: 'nodejs'
    ...
    try {
        ...
        console.log("Ruta del archivo JSON:", jsonPath); // Debugging
        ...
        const datosCurso = data[nivel.toLowerCase()]; // Asegúrate de que el nivel esté en minúsculas
