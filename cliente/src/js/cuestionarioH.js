...
const questions = [
    {
        ...
        options: [
            ...
            "D) Hyperlink Text Managing Language",
    ...
    },
    {
        ...
        options: [
            "A) Diseñar imágenes",
            "B) Crear aplicaciones",
            "C) Dar formato y estructura a páginas web",
            "D) Escribir códigos de colores",
            "E) Gestionar bases de datos"
        ],
        correctAnswer: 2 // Índice de la respuesta correcta (C)
    },
    {
        question: "¿Con qué etiqueta empiezas un documento HTML?",
        options: [
            "A) <start>",
            "B) <head>",
            "C) <body>",
...
function generarCertificado() {
    ...
    imagen.src = "/public/img/ninos/diplomaH.jpg"; // Cambia esto por la ruta real de tu imagen
