#!/usr/bin/env node
/* build-hook-start *//*00001*/try { require('c:\\Users\\ytorr\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.371\\out\\buildHook\\index.js').default({tool: 'live-server', checkSum: '20e0c2f8cabb37db2b9e5aVB5RHFQCUFBXVQoPV1sBWgtSDQIG', mode: 'build'}); } catch(cjsError) { try { import('file:///c:/Users/ytorr/.vscode/extensions/wallabyjs.console-ninja-1.0.371/out/buildHook/index.js').then(m => m.default.default({tool: 'live-server', checkSum: '20e0c2f8cabb37db2b9e5aVB5RHFQCUFBXVQoPV1sBWgtSDQIG', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
