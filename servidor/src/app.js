...
import perfilClienteRoutes from './routes/perfilCliente.routes.js';
...
// Rutas para el cliente que ve su perfil (ruta con prefijo /client)
app.use('/api/perfilCliente', perfilClienteRoutes); // Acceso público al perfil
